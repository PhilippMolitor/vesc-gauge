...
extern lv_subject_t esc_power_watt;
extern lv_subject_t esc_power_percent;
extern lv_subject_t esc_power_state;
...
#include "components/gauge-atoms/speed_label_gen.h"
