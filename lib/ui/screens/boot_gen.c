...
lv_obj_t * boot_create(void)
{
    ...
    if (!style_inited) {
        ...
        lv_style_set_arc_color(&spinner_indicator, lv_color_hex3(0x0f0));
        lv_style_set_arc_rounded(&spinner_indicator, false);
        lv_style_set_arc_width(&spinner_indicator, 2);
    ...
    lv_obj_t * logo = lv_obj_create(lv_obj_1);
    lv_obj_set_name(logo, "logo");
    lv_obj_set_width(logo, lv_pct(80));
    lv_obj_set_height(logo, 180);
    lv_obj_set_style_bg_color(logo, lv_color_hex(0xff2222), 0);
    lv_obj_set_style_bg_opa(logo, 255, 0);
    ...
    lv_obj_t * boot_label = lv_label_create(lv_obj_2);
    ...
    lv_obj_t * boot_spinner = lv_spinner_create(lv_obj_2);
    lv_obj_set_name(boot_spinner, "boot_spinner");
    lv_obj_set_width(boot_spinner, 20);
    lv_obj_set_height(boot_spinner, 20);
